(() => {
      ...
      465: function (e) {
        (e.exports = (function () {
          ...
          const n = {},
            ...
            p = function (e) {
              let t =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : null;
              var o;
              (o = `"${e}" is deprecated and will be removed in the next major release.${
                t ? ` Use "${t}" instead.` : ""
              }`),
                w.includes(o) || (w.push(o), d(o));
            },
            ...
            T = () => v(`.${i.actions} .${i.confirm}`),
            L = () => v(`.${i.actions} .${i.cancel}`),
            P = () => v(`.${i.actions} .${i.deny}`),
            S = () => v(`.${i.loader}`),
            O = () => y(i.actions),
            j = () => y(i.footer),
            ...
            H = () => {
              ...
              const t = e.querySelectorAll(
                ...
                s = Array.from(n).filter(
                  (e) => "-1" !== e.getAttribute("tabindex")
                );
              return [...new Set(o.concat(s))].filter((e) => ee(e));
            },
            z = () =>
            ...
            V = (e, t, o) => {
              if (
                ...
                return;
              const n = t.customClass[o];
              n &&
                ("string" == typeof n || n.forEach
                  ? U(e, n)
                  : d(
                      `Invalid type of customClass.${o}! Expected string or iterable object, got "${typeof n}"`
                    ));
            },
            F = (e, t) => {
              if (!t) return null;
            ...
            Y = (e, t) => {
              ...
              for (let e = 0; e < o.length; e++) {
                const n = o[e];
                if (n instanceof HTMLElement && N(n, t)) return n;
              }
            },
            Z = (e, t, o) => {
            ...
            ce = (e, t) => {
              e.jquery ? de(t, e) : D(t, e.toString());
            },
            de = (e, t) => {
          ...
          function pe(e, t, o) {
            const n = c(t);
            Q(e, o[`show${n}Button`], "inline-block"),
              D(e, o[`${t}ButtonText`] || ""),
          ...
          (Ae.text =
            ...
            (Ae.checkbox = (e, t) => {
              const o = F(x(), "checkbox");
              (o.value = "1"), (o.checked = Boolean(t.inputValue));
              const n = e.querySelector("span");
              return D(n, t.inputPlaceholder || t.inputLabel), o;
            }),
            (Ae.textarea = (e, t) => {
              Ce(e, t.inputValue), ye(e, t), xe(e, e, t);
              return (
                setTimeout(() => {
                  if ("MutationObserver" in window) {
                    const o = parseInt(window.getComputedStyle(x()).width);
                    new MutationObserver(() => {
          ...
          const Ee = (e, t) => {
              ...
              o &&
                ...
                V(o, t, "htmlContainer"),
                t.html
                  ? (le(t.html, o), W(o, "block"))
                  : t.text
                  ? ((o.textContent = t.text), W(o, "block"))
                  : X(o),
                ((e, t) => {
                  const o = x();
                  if (!o) return;
            ...
            Be = (e, t) => {
              for (const [o, n] of Object.entries(r)) t.icon !== o && K(e, n);
              U(e, t.icon && r[t.icon]), Le(e, t), $e(), V(e, t, "icon");
            },
            $e = () => {
              const e = x();
              if (!e) return;
            ...
            Se = (e, t) => {
              const o = t.showClass || {};
              (e.className = `${i.popup} ${ee(e) ? o.popup : ""}`),
                t.toast
                  ? (U(
                      [document.documentElement, document.body],
                      i["toast-shown"]
            ...
            Oe = (e) => {
              ...
              return U(t, i["progress-step"]), D(t, e), t;
            },
            je = (e) => {
              const t = document.createElement("li");
              return (
              ...
              ((e, t) => {
                ...
                if (o && n) {
                  if (t.toast) {
                    ...
                    const e = S();
                    e && n.insertBefore(e, k());
                  } else Z(n, "width", t.width);
                ...
                ((e, t) => {
                  const o = he.innerParams.get(e),
                    n = k();
                  if (n) {
                    if (o && t.icon === o.icon) return Te(n, t), void Be(n, t);
                    if (t.icon || t.iconHtml) {
                      ...
                      W(n),
                        Te(n, t),
                        Be(n, t),
                        U(n, t.showClass && t.showClass.icon);
                    } else X(n);
                  }
                })(e, t),
                ((e, t) => {
                  ...
                  o &&
                    (t.imageUrl
                      ? (W(o, ""),
                        ...
                        Z(o, "width", t.imageWidth),
                        Z(o, "height", t.imageHeight),
                        (o.className = i.image),
                        V(o, t, "image"))
                      : X(o));
                })(0, t),
                ((e, t) => {
                  ...
                  o &&
                    (J(o),
                    Q(o, t.title || t.titleText, "block"),
                    t.title && le(t.title, o),
                ...
                ((e, t) => {
                  ...
                  o &&
                    (J(o),
                    Q(o, t.footer, "block"),
                    t.footer && le(t.footer, o),
                    V(o, t, "footer"));
                })(0, t);
              const o = x();
              "function" == typeof t.didRender && o && t.didRender(o),
                n.eventEmitter.emit("didRender", o);
            },
            qe = () => {
              var e;
              ...
              e &&
                (t.isComposing ||
                  ...
                  "Enter" === t.key
                    ...
                    : "Tab" === t.key
                    ? Re(t)
                    : [...De, ...Ne].includes(t.key)
                    ? _e(t.key)
                    : "Escape" === t.key && Ue(t, e, o)));
            },
            Fe = (e, t) => {
            ...
            Ue = (e, t, o) => {
              m(t.allowEscapeKey) && (e.preventDefault(), o(He.esc));
            };
          var Ke = {
          ...
          const Ye = () => {
            ...
            Ze = "undefined" != typeof window && !!window.GestureEvent,
            We = () => {
              const e = b();
              if (!e) return;
              let t;
          ...
          const nt = (e) => {
            ...
            K(t, o.showClass.popup), U(t, o.hideClass.popup);
            const n = b();
            return (
              K(n, o.showClass.backdrop),
              U(n, o.hideClass.backdrop),
              rt(e, t, o),
              !0
            );
          };
          ...
          const at = (e) => {
            ...
            rt = (e, t, o) => {
              ...
              "function" == typeof o.willClose && o.willClose(t),
                n.eventEmitter.emit("willClose", t),
                a
                  ? lt(e, t, s, o.returnFocus, o.didClose)
                  : tt(e, s, o.returnFocus, o.didClose);
            },
            lt = (e, t, o, s, a) => {
              ue &&
                ((n.swalCloseEventFinishedCallback = tt.bind(null, e, o, s, a)),
            ...
            ct = (e, t) => {
              setTimeout(() => {
                "function" == typeof t && t.bind(e.params)(),
                  n.eventEmitter.emit("didClose"),
                  e._destroy && e._destroy();
              });
            },
            dt = (e) => {
              let t = x();
              if ((t || new Ro(), (t = x()), !t)) return;
              const o = S();
              I() ? X(k()) : ut(t, e),
                W(o),
            ...
            ht = (e, t) => {
              ...
              const n = (e) => {
                "select" === t.input
                  ? (function (e, t, o) {
                      const n = Y(e, i.select);
                      if (!n) return;
                      const s = (e, t, n) => {
                        const s = document.createElement("option");
                        (s.value = n),
                          D(s, t),
                          (s.selected = bt(n, o.inputValue)),
                          e.appendChild(s);
                      };
                      t.forEach((e) => {
                        const t = e[0],
          ...
          const ft = (e) => {
              ...
              return (
                e instanceof Map
                  ? e.forEach((e, o) => {
                      let n = e;
                      "object" == typeof n && (n = ft(n)), t.push([o, n]);
                    })
              ...
              o.inputValidator
                ...
                ? (e.enableButtons(),
                  e.showValidationMessage(
                    o.validationMessage || n.validationMessage
                  ))
                : "deny" === t
                ? xt(e, s)
                : At(e, s);
            ...
            xt = (e, t) => {
              const o = he.innerParams.get(e || void 0);
              o.showLoaderOnDeny && dt(P()),
                o.preDeny
          ...
          function Lt(e, t) {
            ...
            if (o && e)
              if ("radio" === e.type) {
                const e = o.querySelectorAll(`[name="${i.radio}"]`);
          ...
          function Mt(e) {
            ...
            D(t.validationMessage, e),
              ...
              o.customClass &&
                ...
                U(t.validationMessage, o.customClass.validationMessage),
          ...
          const Ht = {
            ...
            Nt = (e) => Object.prototype.hasOwnProperty.call(Ht, e),
            Vt = (e) => -1 !== zt.indexOf(e),
            Ft = (e) => It[e],
            Rt = (e) => {
              Nt(e) || d(`Unknown parameter "${e}"`);
            },
            _t = (e) => {
              Dt.includes(e) &&
          ...
          const Yt = (e) => {
            ...
            return (
              Object.keys(e).forEach((o) => {
                Vt(o) ? (t[o] = e[o]) : d(`Invalid parameter to update: ${o}`);
              }),
              t
            );
          };
          function Zt() {
            ...
            t
              ? (e.popup &&
                ...
                n.eventEmitter.emit("didDestroy"),
                Wt(this))
              : Xt(this);
          }
          const Wt = (e) => {
          ...
          const Qt = (e, t, o) => {
              t.popup.onclick = () => {
                (e && (eo(e) || e.timer || e.input)) || o(He.close);
              };
            },
            eo = (e) =>
              !!(
          ...
          const uo = (e) => {
            for (let t = e.target; t && t !== document; t = t.parentNode)
              for (const e in co) {
                ...
                if (o) return void co[e].fire({ template: o });
              }
          };
          ...
          var wo = Object.freeze({
            ...
            argsToParams: (e) => {
              const t = {};
              return (
                "object" != typeof e[0] || ao(e[0])
                  ? ["title", "html", "icon"].forEach((o, n) => {
                      const s = e[n];
                      "string" == typeof s || ao(s)
                        ? (t[o] = s)
                        : void 0 !== s &&
                          u(
            ...
            bindClickHandler: function () {
              (co[
                ...
                lo || (document.body.addEventListener("click", uo), (lo = !0));
            },
            clickCancel: () => {
              var e;
            ...
            on: (e, t) => {
              n.eventEmitter.on(e, t);
            },
            once: (e, t) => {
              n.eventEmitter.once(e, t);
            },
            resumeTimer: ro,
            showLoading: dt,
            stopTimer: io,
          ...
          const mo = ["swal-title", "swal-html", "swal-footer"],
            ho = (e) => {
              const t = {};
              return (
            ...
            yo = (e) => {
              ...
              o &&
                (Co(o, ["type", "label", "placeholder", "value"]),
            ...
            xo = (e, t) => {
              ...
              for (const n in t) {
                ...
                a &&
                  (Co(a, []),
                  (o[s.replace(/^swal-/, "")] = a.innerHTML.trim()));
              }
              return o;
            },
            ko = (e) => {
            ...
            Ao = (e) => {
              ...
              "function" == typeof e.willOpen && e.willOpen(o),
                n.eventEmitter.emit("willOpen", o);
              ...
              To(t, o, e),
                ...
                n.eventEmitter.emit("didOpen", o),
                K(t, i["no-transition"]);
            },
            Eo = (e) => {
              const t = x();
              if (e.target !== t || !ue) return;
              const o = b();
              t.removeEventListener(ue, Eo), (o.style.overflowY = "auto");
            },
            Bo = (e, t) => {
              ue && oe(t)
                ? ((e.style.overflowY = "hidden"), t.addEventListener(ue, Eo))
                : (e.style.overflowY = "auto");
            },
            $o = (e, t, o) => {
              (() => {
                if (Ze && !N(document.body, i.iosfix)) {
          ...
          function So(e) {
            (function (e) {
              e.inputValidator ||
                ("email" === e.input && (e.inputValidator = Lo),
                "url" === e.input && (e.inputValidator = Po));
            })(e),
          ...
          class Mo {
            constructor() {
              if ((o(this, jo, void 0), "undefined" == typeof window)) return;
              Oo = this;
              for (
            ...
            _main(e) {
              ...
              if (
                (((e) => {
                  ...
                  for (const t in e) Rt(t), e.toast && _t(t), Ut(t);
                })(Object.assign({}, t, e)),
                n.currentInstance)
              ) {
                const e = Ke.swalPromiseResolve.get(n.currentInstance),
                  { isAwaitingPromise: t } = n.currentInstance;
                n.currentInstance._destroy(),
                  t || e({ isDismissed: !0 }),
                  z() && Ye();
              }
              n.currentInstance = Oo;
              const o = Ho(e, t);
              So(o),
                Object.freeze(o),
              ...
              const s = zo(Oo);
              return Me(Oo, o), he.innerParams.set(Oo, o), qo(Oo, s, o);
            }
            then(e) {
              return t(jo, this).then(e);
            }
            finally(e) {
              return t(jo, this).finally(e);
            }
          }
          const qo = (e, t, o) =>
              new Promise((s, a) => {
                ...
                Ke.swalPromiseResolve.set(e, s),
                  Ke.swalPromiseReject.set(e, a),
                  (t.confirmButton.onclick = () => {
                    ((e) => {
                      const t = he.innerParams.get(e);
                      e.disableButtons(),
                        t.input ? vt(e, "confirm") : At(e, !0);
                    })(e);
                  }),
                  (t.denyButton.onclick = () => {
                    ((e) => {
                      const t = he.innerParams.get(e);
                      e.disableButtons(),
                        t.returnInputValueOnDeny ? vt(e, "deny") : xt(e, !1);
                    })(e);
                  }),
                  ...
                  ((e, t, o) => {
                    e.toast ? Qt(e, t, o) : (oo(t), no(t), so(e, t, o));
                  })(o, t, i),
                  ((e, t, o) => {
                    ze(e),
                      t.toast ||
                        ((e.keydownHandler = (e) => Ve(t, e, o)),
            ...
            Ho = (e, t) => {
              const o = ((e) => {
                ...
                n = Object.assign({}, Ht, t, o, e);
              return (
                (n.showClass = Object.assign({}, Ht.showClass, n.showClass)),
                (n.hideClass = Object.assign({}, Ht.hideClass, n.hideClass)),
                !1 === n.animation &&
                  ((n.showClass = { backdrop: "swal2-noanimation" }),
                  (n.hideClass = {})),
                n
              );
            },
            ...
            Do = (e, t) => {
              if (!t.toast)
                return m(t.allowEnterKey)
                  ? void (No(e) || Vo(e, t) || Ie(-1, 1))
                  : (p("allowEnterKey"), void Fo());
            },
            No = (e) => {
          ...
          (Mo.prototype.disableButtons = St),
            (Mo.prototype.enableButtons = Pt),
            (Mo.prototype.getInput = $t),
            (Mo.prototype.disableInput = jt),
            (Mo.prototype.enableInput = Ot),
            (Mo.prototype.hideLoading = Et),
            (Mo.prototype.disableLoading = Et),
            (Mo.prototype.showValidationMessage = Mt),
            (Mo.prototype.resetValidationMessage = qt),
            (Mo.prototype.close = ot),
            (Mo.prototype.closePopup = ot),
            (Mo.prototype.closeModal = ot),
            (Mo.prototype.closeToast = ot),
            (Mo.prototype.rejectPromise = st),
            (Mo.prototype.update = Kt),
            (Mo.prototype._destroy = Zt),
            Object.assign(Mo, wo),
            Object.keys(Gt).forEach((e) => {
              Mo[e] = function () {
                return Oo && Oo[e] ? Oo[e](...arguments) : null;
              };
            }),
            (Mo.DismissReason = He),
            (Mo.version = "11.14.0");
  ...
  (o.n = (e) => {
    ...
    (() => {
      "use strict";
      const e = "https://notes-api.dicoding.dev/v2",
        t = `${e}/notes`,
        n = async (e, o) => {
          try {
            const n = await fetch(t, {
                ...
                body: JSON.stringify({ title: e, body: o }),
              }),
              s = await n.json();
            if ("success" === s.status) return s.data;
      ...
      class l extends HTMLElement {
        ...
        async handleAddNote() {
          const e = this.shadowRoot.querySelector("#noteTitle").value,
            t = this.shadowRoot.querySelector("#noteBody").value;
          if (e && t)
            try {
              this.showLoading(),
                await n(e, t),
        ...
        showLoading() {
          const e = document.querySelector("#loadingIndicator");
        ...
        (o.innerHTML = ""),
          e.forEach((e) => {
            ...
            n.classList.add("note-card"),
              ...
              n.querySelector(".archive-btn").addEventListener("click", () => {
                e.archived
                  ? (async (e) => {
                      try {
                        const o = await fetch(`${t}/${e}/unarchive`, {
                            method: "POST",
                          }),
                          n = await o.json();
                  ...
                  : (async (e) => {
                      try {
                        const o = await fetch(`${t}/${e}/archive`, {
                            method: "POST",
                          }),
                          n = await o.json();
                        if ("success" === n.status) return n.message;
              ...
              n.querySelector(".delete-btn").addEventListener("click", () => {
                r()
                  .fire({
                    title: "Are you sure?",
      ...
      function d() {
        s(),
          Promise.all([
            fetch(`${e}/notes`).then((e) => e.json()),
            fetch(`${e}/notes/archived`).then((e) => e.json()),
          ])
            .then(([e, t]) => {
              if ("success" !== e.status || "success" !== t.status)
                throw new Error("Failed to fetch notes");
              c(e.data, document.getElementById("activeNotes")),
                c(t.data, document.getElementById("archivedNotes")),
                setTimeout(() => {
                  a();
                }, 100);
            })
      ...
      function u() {
        s();
        const e = document.querySelector("#noteTitle").value,
          t = document.querySelector("#noteBody").value;
        n(e, t)
          .then(() => {
            setTimeout(() => {
              a();
          ...
          .catch((e) => {
            setTimeout(() => {
              ...
              r().fire("Failed to add note!", "Error: " + e.message, "error");
          });
      }
      customElements.get("input-notes") ||
        customElements.define("input-notes", l),
        document.addEventListener("DOMContentLoaded", () => {
          const e = document.getElementById("addNoteBtn");
          e && e.addEventListener("click", u), d();
        });
    })();
})();
